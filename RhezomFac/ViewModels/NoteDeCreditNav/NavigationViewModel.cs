...
using NavigationModel = RhezomFac.Models.NoteDeCreditNav.NavigationModel;

namespace RhezomFac.ViewModels.NoteDeCreditNav
{
    /// <summary>
    ...
    public class NavigationViewModel
    {
        ...
        {
            // A l'ouverture d'une note de credit
            System.Diagnostics.Debug.WriteLine("Note de credit clicked");
        }

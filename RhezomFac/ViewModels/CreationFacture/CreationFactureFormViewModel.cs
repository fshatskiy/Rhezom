...
namespace RhezomFac.ViewModels.CreationFacture
{
    /// <summary>
    /// ViewModel for Business Registration Form page
    /// </summary>
    [Preserve(AllMembers = true)]
    public class CreationFactureFormViewModel : BaseViewModel
    {
        #region Constructor

        /// <summary>
        /// Initializes a new instance of the <see cref="CreationFactureFormViewModel" /> class
        /// </summary>
        public CreationFactureFormViewModel()
        {

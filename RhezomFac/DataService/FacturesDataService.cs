...
using RhezomFac.ViewModels.FacturesNav;
...
namespace RhezomFac.DataService
{
    public class FacturesDataService
    {
        ...
        private static FacturesDataService instance;
        ...
        /// <summary>
        /// Gets an instance of the <see cref="FacturesDataService"/>.
        /// </summary>
        //public static NavigationDataService Instance => instance ?? (instance = new NavigationDataService());
        public static FacturesDataService Instance => instance ??= new FacturesDataService();
